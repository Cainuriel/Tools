...
public class Stringtools {
    ...
    /**
     * Si se desea recortar un String en base a dos caracteres y no a través de
     * una palabra.
     *
    ...
    public static void main(String[] args) {
         ...
         * repetida de caracteres. por ese motivo introducimos un caracter
         * unico, para cambiarlo por el primero de los caracteres repetidos que
         * nos da el primer corte el segundo lo marca el ultimo caracter de los
         * puntos, suerte en este caso, por eso lo introducimos tranquilamente
         * por parametro
         */
